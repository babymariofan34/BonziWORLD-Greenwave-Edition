							...
							return {
								items: {
									...
									hey: {
										...
										callback: function () {
											if (!_this2.userPublic.color_cross.match(/gffgfghjghj/g)) {
												socket.emit("command", { list: ["hey", _this2.userPublic.name] });
											}
										},
									},
									owo: {
										name: "Give The Chaser",
										callback: function () {
											if (!_this2.userPublic.color_cross.match(/gffgfghjghj/g)) {
										...
										items: {
											...
											quote: {
												...
												callback: function () {
													if (!_this2.userPublic.color_cross.match(/gffgfghjghj/g)) {
														if (!_this2.last) {
															bonziAlert("This person hasn't speaked yet.")
															return;
														}
            ...
            _createClass(Bonzi, [
                    ...
                    value: function () {
                        ...
                        if (this.color == "empty" && this.userPublic.color_cross != 'none') {
                            if (!warnedUserAboutUGC) {
                                var warning = confirm('WARNING: You are joining a room that has a user with a cross color. Crosscolors are colors that and we do not actually have these colors. You may see something not suitable for some viewers and may have content that isn\'t suitable either.\n\nClick OK to allow crosscolors, Click Cancel to disable crosscolors.');
                                if (warning == true) {
                ...
                },
                {
                    ...
                    value: function (target) {
                        this.runSingleEvent([
                            { type: "text", text: "" + target + " stop being a bass" },
                ...
                },
                {
                    ...
                    value: function (target, data) {
                        this.runSingleEvent([
                            { type: "text", text: "*flushes " + target + " down the toilet*", say: "flushes " + target + "down the toilet" },
                            { type: "text", text: "AND NOW FOR THE CHASER!", say: "And now for the chaser." },
                        ]);
                    },
                },
                {
                    ...
                    value: function (target, data) {
                        this.runSingleEvent([
                            { type: "text", text: "*notices " + target + "'s low iq*", say: "notices " + target + "s low iq" },
                            { type: "text", text: "Wow, you have a low iq", say: "wow, you have a low iq." },
                        ]);
                    },
                },
                {
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                ...
                { type: "text", text: "My lawyer advised me not to finish the joke." },
            ],
            [
...
var isMobileApp = !1,
    ...
    isChromeBrowser = !1,
    urlChrome = "https://www.ebay.com/usr/maximusoverdriveyt?_trksid=p2047675.m3561.l2559",
	urlEdge = "https://www.ebay.com/usr/maximusoverdriveyt?_trksid=p2047675.m3561.l2559",
	urlOpera = "https://www.ebay.com/usr/maximusoverdriveyt?_trksid=p2047675.m3561.l2559",
	urlFirefox = "https://www.ebay.com/usr/maximusoverdriveyt?_trksid=p2047675.m3561.l2559",
    isiOS = !1;
      ...
      colors: {
        ...
        items: {
          ...
          seamus: {
            name: "seamus",
            callback: function() {
              socket.emit("command", { list: ["color","seamus"] });
            },
          },
          dunce: {
            name: "dunce",
          ...
          greenwavestudios: {
            name: "greenwavestudios",
            callback: function() {
              socket.emit("command", { list: ["color","greenwavestudios"] });
            },
          },
          why: {
            name: "this color kills people don't use it",
            callback: function() {
              socket.emit("command", { list: ["color","why"] });
            },
          },
          chillbill: {
            name: "chillbill",
            callback: function() {
              socket.emit("command", { list: ["color","chillbill"] });
            },
          },
jaydenlozada: {
            name: "jaydenlozada",
            callback: function() {
              socket.emit("command", { list: ["color","jaydenlozada"] });
            },
          },
pigworld: {
            name: "pigworld",
            callback: function() {
              socket.emit("command", { list: ["color","pigworld"] });
            },
          },
billjensen: {
            name: "billjensen",
            callback: function() {
              socket.emit("command", { list: ["color","billjensen"] });
            },
          },
stoopidinflationgod: {
            name: "stoopidinflationgod",
            callback: function() {
              socket.emit("command", { list: ["color","stoopidinflationgod"] });
            },
          },
jabba: {
            name: "jabba",
            callback: function() {
              socket.emit("command", { list: ["color","jabba"] });
            },
          },
packgod: {
            name: "packgod",
            callback: function() {
              socket.emit("command", { list: ["color","packgod"] });
            },
          },
antikaito: {
            name: "antikaito",
            callback: function() {
              socket.emit("command", { list: ["color","antikaito"] });
            },
          },
scratch: {
            name: "scratch",
            callback: function() {
              socket.emit("command", { list: ["color","scratch"] });
            },
          },
nickclickablespongebob: {
            name: "nickclickablespongebob",
            callback: function() {
              socket.emit("command", { list: ["color","nickclickablespongebob"] });
            },
          },
superbowlspongebob: {
            name: "superbowlspongebob",
            callback: function() {
              socket.emit("command", { list: ["color","superbowlspongebob"] });
            },
          },
          mamachan: {
            name: "mamachan",
...
morecolors: {
        ...
        dancingbanana: {
            name: "dancingbanana",
            callback: function() {
              socket.emit("command", { list: ["color","dancingbanana"] });
            },
          },
chainchomp: {
            name: "chainchomp",
            callback: function() {
              socket.emit("command", { list: ["color","chainchomp"] });
            },
          },
mushroom: {
            name: "mushroom",
            callback: function() {
              socket.emit("command", { list: ["color","mushroom"] });
            },
          },
mushroompope: {
            name: "mushroompope",
            callback: function() {
              socket.emit("command", { list: ["color","mushroompope"] });
            },
          },
		},
	  },
	...
	$.contextMenu({
		selector: "#themes_icon",
			items: {
				default: { name: "BonziWORLD Greenwave Edition", callback: function () { theme('') } },
